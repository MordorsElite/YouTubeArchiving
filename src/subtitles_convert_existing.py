...
def generate_converted_subtitles(
    ...
    @param subtitle_file: An autogenerated youtube caption file in vtt format
    @param direct_iterative: Flag deciding generation of these subs
    @param reformatted_non_it: Flag deciding generation of these subs
    @param reformatted_iterative: Flag deciding generation of these subs
